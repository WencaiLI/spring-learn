package com.lwc.springbooteasyexcel;
...
public class ExcelListener extends AnalysisEventListener<VehicleInfoExcelImportDTO> {

    private List<VehicleInfoExcelImportDTO> list = new ArrayList<>();
    /**
     ...
     */
    public ExcelListener(VehicleInfoService vehicleInfoService) {
    ...
    private void saveData() {
        ...
        vehicleInfoService.batchImport(list);
    }
